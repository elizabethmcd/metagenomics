...
def nextflow_runtime(pvc_name: str, args: latch_metadata.WorkflowArgsType) -> None:
    ...
    latch_log_dir = urljoins("latch:///your_log_dir/nf_arcadia_science_metagenomics", exec_name)
...
def nf_arcadia_science_metagenomics(args: latch_metadata.WorkflowArgsType) -> None:
    """
